...
public class ExceptionController {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Map handleConstainVolationException(ConstraintViolationException excetion) {
        StringBuilder stringBuilder = new StringBuilder();
        Set<ConstraintViolation<?>> violations = excetion.getConstraintViolations();
